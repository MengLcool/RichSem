...
def build_focalnet(modelname, **kw):
    assert modelname in ['focalnet_L_384_22k', 'focalnet_L_384_22k_fl4', 'focalnet_XL_384_22k', 'focalnet_H_224_22k_fl4_fd']
    ...
    model_para_dict = {
        ...
        'focalnet_H_224_22k_fl4_fd': dict(
            embed_dim=352,
            depths=[ 2, 2, 18, 2 ],
            focal_levels=kw.get('focal_levels', [4, 4, 4, 4]),
            focal_windows=kw.get('focal_windows', [3, 3, 3, 3]),
            # focal_factors=kw.get('focal_factors', [2, 2, 2, 2]),
            use_conv_embed=True,
            use_postln=True,
            use_layerscale=True,
            use_postln_in_modulation=True,
            normalize_modulator=False,
            # is_teacher=kw.get('is_teacher', False),
        ),    
